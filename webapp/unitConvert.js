...
//inputUnit[1]= new Array("Kilogram","Gram","Milligram","Ton","Pound","Ounce");
factor[1] = new Array(
  1,
  0.001,
  0.000001,
...
//inputUnit[2]=new Array("Cubic Meter","Cubic Kilometer","Cubic Centimeter","Cubic Millimeter","Liter","Milli Liter","Gallon");
factor[2] = new Array(
  1,
  1e9,
  1e-6,
